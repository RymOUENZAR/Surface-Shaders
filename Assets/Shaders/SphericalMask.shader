Shader "Essai/SphericalMask"
{
    Properties
    {
		...
		_EmissionStrength("Color Strength", Range(0,4)) = 1
    ...
    SubShader
    {
		...
		uniform half GLOBALMASK_Radius, GLOBALMASK_Softness;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			// Grayscale
			half grayscale = (c.r + c.g + c.b) * 0.333; // Faster than / 3
